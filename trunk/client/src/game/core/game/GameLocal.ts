...
import { Plunder } from "./mode/Plunder";
import FixedMaths from "../base/fixed/FixedMaths";
import { Adventure } from "./mode/Adventure";
import { Collector } from "../logic/Collector";
import { MartialDisplay } from "./mode/MartialDisplay";
import { SkillEditor } from "./mode/SkillEditor";
    ...
    Init()
    {
        ...
        switch(this.createContext.type)
        {
            ...
            case "MartialDisplay":
                ...
                break;
            case "SkillEditor":
                Runtime.battleModule = new SkillEditor
                break;
        }
